...
namespace Transactions2Small
{
    public static class NeoExtensionMethods
    {
        ...
        public static byte[] AsDisplayOrderBytes(this byte[] bytes)
        {
            ...
            for (int bytesOffset = 0; bytesOffset < len; bytesOffset += 4)
            {
                ...
                dobBytes[dobOffset + 2] = b1;  // This runs fine under Windows (check out the TransAsDisplayOrderBytesTest1 project)
    ...
    public class Transactions2Small : SmartContract
    {

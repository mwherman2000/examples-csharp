...
namespace Transactions2
{
    public class Transactions2 : SmartContract
    {
        ...
        public static void Main()
        {
            ...
            Runtime.Notify("WIF1AccountScriptHash", WIF1AccountScriptHash.Length, WIF1AccountScriptHash);
            ...
            Runtime.Notify("WIF2AccountScriptHash", WIF2AccountScriptHash.Length, WIF2AccountScriptHash);
